...
export class CommandParser {
  parse(rawText: string): ParseResult {
    ...
    if (!amountValue) missingFields.push('amount', 'currency');
  ...
  private clarification(
    ...
    if (missingFields.includes('side')) clarificationQuestion = 'Do you want YES or NO?';
    else if (missingFields.includes('amount')) clarificationQuestion = 'How much do you want to spend?';
